...
config.Data.userInputFiles = open('Run398395_ZMu.txt').readlines()
...
config.Data.outLFNDirBase = '/eos/cms/store/group/phys_muon/ec/HLT/MuonHLTRun3_PixelDegradation_From2024B/DQMTest/Run398395/'
